    ...
    <>
      <div className="service-sidebar-area sp1">
        <Container>
          <Row>
            <Col lg={8}>
              <div className="service2-widget-sidebar rightside">
                <div className="img1 image-anime">
                  <Image src={ser2} alt="" width={806} className='img-fluid' />
                </div>
                ...
                <Row>
                  <Col lg={6} md={6}>
                    ...
                    <div className="img1 image-anime">
                      <Image src={img3} alt="" width={391} className='img-fluid' />
                    </div>
                  </Col>
                  <Col lg={6} md={6}>
                    <div className="space30" />
                    <div className="img1 image-anime">
                      <Image src={img4} alt="" width={391} className='img-fluid' />
                    </div>
                  </Col>
                </Row>
                <div className="space32" />
